package project.alexoshiro.graphql.registerapi.migration;
...
public class MigrationSetup {
	...
	public SpringMongock mongock(ApplicationContext springContext, MongoClient mongoClient, Environment environment) {
		...
		return new SpringMongockBuilder(mongoclient, database, "project.alexoshiro.graphql.registerapi.migration.changelogs")
